...
> ⚠️ **历史快照(2026-07-01 标注)**：本报告描述 2026-06-26 测试时环境(桌面端仍是 Electron)。当前生产 DMG 已切 Tauri 2(见 [[../../../docs/architecture.md]] §2)。报告内 "Electron desktop" 指当时测试的真实运行产品,**不需修改** —— 仅在此注明时间锚点。
