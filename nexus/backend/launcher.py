...
def _patch_cocoa_close_behavior() -> None:
    ...
    _BrowserView = _cocoa.BrowserView  # noqa: N806 - PyObjC 类名,保持驼峰以匹配 runtime 协议

    def _patched_windowShouldClose_(self, window):  # noqa: ANN001,N802 - NSWindowDelegate 签名,保持驼峰
    ...
    def _patched_applicationShouldHandleReopen_hasVisibleWindows_(self, app, flag):  # noqa: ANN001,N802 - NSAppDelegate 签名
